 ...
 * in it.
 * The PR number can be extracted by parsing the contents of the squash and merge commit message, 
 ...
 * 
 * @param {String} pullNumber Index of the pull request for which to retrieve inner (conventional) commits.
 *
...
export async function getPullRequestCommits(context, pullNumber) {
  ...
  debug(`Fetch commits from squash and merge pull request ${pullNumber}`);
